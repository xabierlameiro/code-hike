...
const EditorFrame = React.forwardRef(function InnerEditorFrame(_a, ref) {
    ...
    return (React.createElement("div", Object.assign({ ref: ref }, rest, { className: "ch-editor-frame", style: Object.assign({ background: getColor(theme, ColorName.EditorBackground) }, style) }),
        React.createElement("div", { className: "ch-frame-title-bar", style: {
            ...
            React.createElement(TabsContainer, { tabs: northPanel.tabs, showFrameButtons: true, button: northButton, panel: "north", theme: theme, onTabClick: onTabClick, render: render })),
        ...
        southPanel && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "ch-frame-title-bar", style: {
                ...
                React.createElement(TabsContainer, { tabs: southPanel.tabs, showFrameButtons: false, button: southButton, topBorder: true, panel: "south", theme: theme, onTabClick: onTabClick, render: render })),
...
function TabsContainer({ tabs, button, showFrameButtons, topBorder, panel, theme, onTabClick, render, }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        showFrameButtons ? (React.createElement(FrameButtons, { render: render })) : (React.createElement("div", null)),
...
function Code(props) {
    ...
    return (React.createElement(InnerCode, Object.assign({}, step, { onTabClick: onTabClick, render: props.render })));
}
