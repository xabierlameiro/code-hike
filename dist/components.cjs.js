...
const EditorFrame = React__default["default"].forwardRef(function InnerEditorFrame(_a, ref) {
    var _b;
    var { northPanel, southPanel, terminalPanel, style, height, northButton, southButton, theme, render, className, onTabClick } = _a, rest = __rest(_a, ["northPanel", "southPanel", "terminalPanel", "style", "height", "northButton", "southButton", "theme", "render", "className", "onTabClick"]);
    return (React__default["default"].createElement("div", Object.assign({ ref: ref }, rest, { className: "ch-editor-frame", style: Object.assign({ background: getColor(theme, ColorName.EditorBackground) }, style) }),
        React__default["default"].createElement("div", { className: "ch-frame-title-bar", style: {
            ...
            React__default["default"].createElement(TabsContainer, { tabs: northPanel.tabs, showFrameButtons: true, button: northButton, panel: "north", theme: theme, onTabClick: onTabClick, render: render })),
        ...
        southPanel && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("div", { className: "ch-frame-title-bar", style: {
                ...
                React__default["default"].createElement(TabsContainer, { tabs: southPanel.tabs, showFrameButtons: false, button: southButton, topBorder: true, panel: "south", theme: theme, onTabClick: onTabClick, render: render })),
            React__default["default"].createElement("div", { "data-ch-panel": "south", children: southPanel.children, style: southPanel.style })))));
});
function TabsContainer({ tabs, button, showFrameButtons, topBorder, panel, theme, onTabClick, render, }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        showFrameButtons ? (React__default["default"].createElement(FrameButtons, { render: render })) : (React__default["default"].createElement("div", null)),
...
function Code(props) {
    ...
    return (React__default["default"].createElement(InnerCode, Object.assign({}, step, { onTabClick: onTabClick, render: props.render })));
}
...
function InnerCode(_a) {
    var { onTabClick, render } = _a, props = __rest(_a, ["onTabClick", "render"]);
