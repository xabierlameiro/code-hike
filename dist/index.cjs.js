...
var unistVisit__default = /*#__PURE__*/_interopDefaultLegacy(unistVisit);
...
var visitParents__default = /*#__PURE__*/_interopDefaultLegacy(visitParents);
...
function visit(tree, type, visitor) {
    unistVisit__default["default"](tree, type, visitor);
}
...
function mdastToEstree(node) {
    ...
    const changedTree = unified__default["default"]()
...
function rehypeRecma() {
    return (tree) => toEstree__default["default"](tree);
}
...
const FONT_STYLE_TO_CSS = {
    [shiki.FontStyle.NotSet]: {},
    [shiki.FontStyle.None]: {},
    [shiki.FontStyle.Italic]: { fontStyle: "italic" },
    [shiki.FontStyle.Bold]: { fontWeight: "bold" },
    [shiki.FontStyle.Underline]: { textDecoration: "underline" },
};
...
function getPresetConfig(attributes) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { default: fetch } = yield Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('node-fetch')); });
...
function getAncestors(tree, node) {
    let ancestors = [];
    visitParents__default["default"](tree, node, (node, nodeAncestors) => {
...
exports.remarkCodeHike = attacher;
